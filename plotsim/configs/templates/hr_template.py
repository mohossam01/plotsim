...
config = create(
    ...
    metrics=[
        {"name": "performance_score", "label": "Quarterly performance rating",
         "type": "score", "polarity": "positive"},

        {"name": "engagement", "label": "Pulse engagement index",
         "type": "score", "polarity": "positive"},

        {"name": "training_hours", "label": "Training hours completed",
         "type": "count", "polarity": "positive"},

        {"name": "absence_rate", "label": "Monthly absence rate",
         "type": "score", "polarity": "negative",
         "follows": "engagement", "delay": 1},

        {"name": "attrition_risk", "label": "Attrition risk score",
         "type": "score", "polarity": "negative"},

        {"name": "compensation", "label": "Total monthly compensation",
         "type": "amount", "polarity": "positive",
         "range": [4000, 25000]},
    ],
    ...
    facts=[
        {"name": "fct_performance",
         ...
         "columns": [
             ...
             {"name": "review_outcome", "type": "bucket",
    ...
    events=[
        {"name": "evt_training_completion",
         "trigger": "proportional", "driver": "engagement", "scale": 4.0,
         "columns": [
        ...
        {"name": "evt_attrition",
         "trigger": "threshold", "metric": "attrition_risk",
         "above": 0.7, "for_periods": 3,
         "columns": [
             {"name": "event_id", "type": "id"},
             {"name": "date_key", "type": "ref.dim_date"},
             {"name": "employee_id", "type": "ref.dim_employee"},
