    ...
    segments=[
        {
            ...
            "attributes": {
                "program": ["computer_science", "engineering"],
        ...
        },
        {
            ...
            "attributes": {
                "program": ["biology", "mathematics", "history"],
        ...
        },
        {
            ...
            "attributes": {"program": ["business", "communications"], "year": ["junior", "senior"]},
        ...
        },
        {
            ...
            "attributes": {"program": ["undeclared", "business"], "year": ["freshman"]},
            "baseline": {
        ...
        },
        {
            ...
            "attributes": {"program": ["pre_med", "engineering"], "year": ["junior", "senior"]},
            "baseline": {"study_hours": "high", "stress_level": "high", "dropout_risk": "high"},
        },
        {
            "name": "seasonal_engagement",
            "count": 12,
            "archetype": "seasonal",
            "label": "Cyclical engagement — strong terms, weak summers",
            "attributes": {
                "program": ["arts", "music", "history"],
                "year": ["sophomore", "junior"],
            },
    ...
    dimensions=[
        ...
        },
        {
            ...
            "columns": [
                ...
                {"name": "term_name", "type": "static.spring_2023,fall_2023,spring_2024,fall_2024"},
    ...
    facts=[
        {
            ...
            "columns": [
                ...
                {"name": "grade_band", "type": "bucket", "labels": ["F", "D", "C", "B", "A"]},
            ],
        },
        {
            "name": "fct_engagement",
