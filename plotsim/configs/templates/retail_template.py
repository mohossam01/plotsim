...
config = create(
    ...
    metrics=[
        {"name": "sessions", "label": "Monthly site sessions",
         "type": "count", "polarity": "positive"},

        {"name": "cart_value", "label": "Average cart value",
         "type": "amount", "polarity": "positive", "range": [10, 2000]},

        {"name": "conversion_rate", "label": "Session-to-purchase conversion",
         "type": "score", "polarity": "positive"},

        {"name": "return_rate", "label": "Purchase return rate",
         "type": "score", "polarity": "negative"},

        {"name": "loyalty_score", "label": "Customer loyalty index",
         "type": "score", "polarity": "positive"},

        {"name": "repeat_purchase_rate", "label": "Repeat purchase rate",
         "type": "score", "polarity": "positive",
         "follows": "loyalty_score", "delay": 1},

        {"name": "nps", "label": "Net promoter score",
         "type": "index", "polarity": "positive", "range": [-100, 100]},
    ],
    ...
    segments=[
        ...
        {"name": "escalating_basket", "count": 10, "archetype": "accelerating",
    ...
    dimensions=[
        ...
        {"name": "dim_customer", "per": "unit",
         "columns": [
             {"name": "customer_id", "type": "id"},
             {"name": "customer_name", "type": "faker.name"},
             {"name": "signup_year", "type": "faker.year"},
             {"name": "cohort_size", "type": "segment.count"},
             {"name": "customer_tier", "type": "scd",
              "tracks": "loyalty_score",
              "tiers": ["browser", "casual", "loyal"],
              "at": [0.3, 0.7]},
         ]},

        {"name": "dim_product_category", "reference": True,
         "columns": [
             {"name": "category_id", "type": "id"},
             {"name": "category_name",
              "type": "static.electronics,apparel,home,grocery,beauty"},
             {"name": "margin_tier",
              "type": "static.high,standard,standard,low,high"},
         ]},
    ...
    facts=[
        {"name": "fct_sessions",
         ...
         "columns": [
             ...
             {"name": "shopping_intent", "type": "bucket",
              "labels": ["browsing", "comparing", "purchasing", "loyal_repeat"]},
         ]},

        {"name": "fct_purchases",
         "metrics": ["cart_value", "return_rate", "loyalty_score",
         ...
         "columns": [
             ...
             {"name": "repeat_purchase_rate",
              "type": "metric.repeat_purchase_rate"},
         ]},
    ...
    events=[
        {"name": "evt_purchase",
         "trigger": "proportional", "driver": "conversion_rate", "scale": 6.0,
         "columns": [
        ...
        {"name": "evt_churn",
         "trigger": "threshold", "metric": "loyalty_score",
         "below": 0.15, "for_periods": 4,
         "columns": [
             {"name": "event_id", "type": "id"},
             {"name": "date_key", "type": "ref.dim_date"},
             {"name": "customer_id", "type": "ref.dim_customer"},
