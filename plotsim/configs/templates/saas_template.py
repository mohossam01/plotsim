...
config = create(
    ...
    metrics=[
        {"name": "engagement", "label": "Product engagement",
        ...
        {"name": "support_tickets", "label": "Support ticket volume",
         "type": "count", "polarity": "negative",
         "follows": "engagement", "delay": 2},

        {"name": "feature_adoption", "label": "Feature adoption rate",
         "type": "score", "polarity": "positive"},

        {"name": "churn_risk", "label": "Churn risk score",
         "type": "score", "polarity": "negative"},

        {"name": "nps", "label": "Net promoter score",
         "type": "index", "polarity": "positive",
         "range": [-100, 100]},
    ],
    ...
    segments=[
        {"name": "promising_client", "count": 20,
         ...
         "baseline": {"mrr": "high", "engagement": "high",
                      "support_tickets": "low"}},

        {"name": "steady_enterprise", "count": 25,
         "archetype": "growth",
        ...
        {"name": "slow_churn", "count": 15,
         ...
         "baseline": {"mrr": "low", "engagement": "low",
                      "support_tickets": "high"}},

        {"name": "seasonal_accounts", "count": 15,
         ...
         "baseline": {"mrr": "mid", "engagement": "mid",
                      "support_tickets": "mid"}},

        {"name": "dormant", "count": 10,
         "archetype": "flat",
