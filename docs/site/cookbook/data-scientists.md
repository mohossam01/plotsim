...
[**ml_readiness.ipynb**](https://github.com/mohossam-ae/plotsim/blob/main/docs/tutorial-notebooks/ml_readiness.ipynb)
...
The [`saas_template.py`](https://github.com/mohossam-ae/plotsim/blob/main/plotsim/configs/new/saas_template.py)
...
[`bridges_and_advanced.ipynb`](https://github.com/mohossam-ae/plotsim/blob/main/docs/tutorial-notebooks/bridges_and_advanced.ipynb).
...
- [designing_archetypes.ipynb](https://github.com/mohossam-ae/plotsim/blob/main/docs/tutorial-notebooks/designing_archetypes.ipynb) —
  the archetype DSL in depth
- [seasonality_and_correlations.ipynb](https://github.com/mohossam-ae/plotsim/blob/main/docs/tutorial-notebooks/seasonality_and_correlations.ipynb) —
