...
def test_manifest_schema_bumped_to_1_7():
    ...
    # ``noise_config`` field (0.6-M22). This module's contract tracks the
    # pin at the schema level, not the field semantics.
...
def test_bundled_template_loads_and_validates(tmp_path: Path):
    ...
    assert manifest_payload["schema_version"] == "1.7"
