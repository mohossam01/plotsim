...
def test_manifest_schema_version_pins_1_9():
    """0.6-M22 bumped the manifest schema version 1.6 → 1.7; 0.6-M23 bumped
    1.7 → 1.8; 0.6-M24 bumped 1.8 → 1.9 for the additive
    ``target_metric`` field on ``TreatmentAssignment`` /
    ``TreatmentCohort``. The test_schema_version_bumped_to_1_9 test in
